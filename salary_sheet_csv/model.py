...
class SalarySheetCSVrep(models.AbstractModel):
    _name = 'report.salary_sheet_csv.salary_sheet_csv_id'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        salary_rules = self.env['hr.salary.rule'].search([('active','=',True),('appears_on_salary_sheet','=',True)])
        ...
        for x in salary_categs:
            for y in records:
                for z in y.line_ids:
                    if z.salary_rule_id.appears_on_salary_sheet:
        ...
        departments = []
        for x in records:
            if x.employee_id.department_id:
