...
class SalarySheet(models.TransientModel):
	...
	def _print_report(self, data):
		...
		return self.env.ref('salary_sheet_csv.report_for_salary_sheet_csv_id').report_action(self, data=data)
...
# class hr_salary_rule_ext_sheet(models.Model):
#     _inherit = 'hr.salary.rule'

#     appears_on_salary_sheet = fields.Boolean(string="Appears On Salary Sheet")    
